...
export default class Denoiser {
	...
	get texture() {
		...
		if(this.options.denoiseMode === "denoised") { return this.denoisePass.texture; } else if(this.options.denoiseMode === "temporal") { return this.temporalReprojectPass.texture; } else if(this.options.denoiseMode.startsWith("full")) { return this.denoiserComposePass.renderTarget.texture; }
