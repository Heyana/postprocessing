...
export class GlowMTU {
    ...
    postProcessing() {
        ...
        if (this.bloomRenderPass) {
            ...
            this.bloomRenderPass = new MTRenderPass(this.mtuPP.mainScene, this.mtuPP.mainCamera);
        ...
        if (this.mixingPass) {
            ...
            this.mixingPass = new MTMixShaderPass(GlowEffectShader, "baseTexture", "bloomTexture");
