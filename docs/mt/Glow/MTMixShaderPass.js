...
export class MTMixShaderPass extends Pass {
    constructor(shader, baseTextureID, effectTextureID) {
        super();
        this.baseTextureID =
            baseTextureID !== undefined ? baseTextureID : "tDiffuse";
        this.effectTextureID =
            effectTextureID !== undefined ? effectTextureID : "tDiffuse";
